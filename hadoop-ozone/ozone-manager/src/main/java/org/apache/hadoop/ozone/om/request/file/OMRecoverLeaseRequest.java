...
public class OMRecoverLeaseRequest extends OMKeyRequest {
    ...
    private String getOpenFileEntryName(long volumeId, long bucketId,
        ...
        try (TableIterator<String, ? extends Table.KeyValue<String, OmKeyInfo>>
            ...
            while (iter.hasNext()) {
                ...
                //openFileEntryName = keyInfo.getFileName();
    ...
    private void checkFileState(OmKeyInfo keyInfo, String openKeyEntryName) throws IOException {
    ...
    private void removeOpenKey(String openKeyName, long transactionLogIndex) throws IOException {
