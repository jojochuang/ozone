 ...
 */
public class ContainerReportInsight extends BaseInsightPoint {
  ...
  public List<LoggerSource> getRelatedLoggers(boolean verbose,
    ...
    loggers.add(
        new LoggerSource(Type.SCM, ContainerReportHandler.class,
  ...
  public String getDescription() {
    return "SCM Container Report handler related information.";
  }
