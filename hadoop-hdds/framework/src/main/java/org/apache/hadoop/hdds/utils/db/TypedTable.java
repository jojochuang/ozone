...
public class TypedTable<KEY, VALUE> implements Table<KEY, VALUE> {
  ...
  private List<VALUE> multiGetFromTableWithByteArray(List<KEY> keys)
      throws RocksDatabaseException, CodecException {
  ...
  private List<VALUE> multiGetFromTableWithCodecBuffer(List<KEY> keys)
      throws RocksDatabaseException, CodecException {
  ...
  private void applyMultiGetStatuses(List<ByteBufferGetStatus> statuses,
      List<CodecBuffer> valueBuffers, int valueBufferCapacity, List<VALUE> values,
      List<Integer> retryIndices, List<Integer> retrySizes) throws CodecException {
  ...
  private void retryOversizedMultiGet(List<ByteBuffer> keyByteBuffers, List<Integer> retryIndices,
      List<Integer> retrySizes, List<VALUE> values)
      throws RocksDatabaseException, CodecException {
  ...
  private static void addWritableValueByteBuffer(CodecBuffer valueBuffer, int capacity,
  ...
  private static void validateMultiGetStatus(ByteBufferGetStatus status, Integer expectedSize) {
  ...
  private VALUE decodeFromMultiGetStatus(ByteBufferGetStatus status, CodecBuffer valueBuffer)
